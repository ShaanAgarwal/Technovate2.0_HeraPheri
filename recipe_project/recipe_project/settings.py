...
if not GEMINI_API_KEY:
    raise ValueError(
        "No GEMINI_API_KEY found in environment variables. Please check your .env file.")
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'recipe_generator', 'static'),
]
...
SECRET_KEY = "django-insecure-*a_jei3=!o(&$-#)gka4c)x)e1lb)9w)k_vgksia8c2qe$%u3m"
...
APPEND_SLASH = False  # Add this line to your settings.py
